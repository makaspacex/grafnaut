...
const step1TutorialTitle = 'Grafnaut fundamentals';
...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to Grafnaut',
    subheading: 'The steps below will guide you to quickly finish setting up your Grafnaut installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your Grafnaut installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'Set up and understand Grafnaut if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
  ...
  },
  {
    ...
    subheading:
      'All necessary steps to use Grafnaut are done. Now tackle advanced steps or make the best use of this home dashboard – it is, after all, a fully customizable dashboard – and remove this panel.',
    title: 'Advanced',
